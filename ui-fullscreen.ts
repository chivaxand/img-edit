...
export class FullScreenWorkspace {
    ...
    private injectStyles() {
        ...
        style.textContent = `
            .fs-workspace-overlay { position: fixed; top: 0; left: 0; right: 0; bottom: 0; width: 100%; height: 100%; background: #121212; z-index: 9999; display: flex; flex-direction: column; color: #e0e0e0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: 13px; box-sizing: border-box; }
